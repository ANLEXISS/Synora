...
func (e *ShadowEngine) submitWorkflow(observation chains.ObservationRef, historical *decisioncomparison.HistoricalDecisionRef) (result ShadowAdmissionResult) {
	...
	input := shadowworkflow.ShadowWorkflowInput{EventID: observation.ID, ObservedAt: observed, ReceivedAt: observed, Observation: value, HistoricalChainID: observation.HistoricalChainID, SourceShadowRevision: status.JournalSequence, SourceShadowFingerprint: status.JournalHeadHash}
	if historical != nil {
