...
func (s *Server) register() {
	...
	s.handlers["incidents.list"] = s.incidentsList
	s.handlers["incidents.get"] = s.incidentGet
	s.handlers["incidents.mark_viewed"] = s.incidentMarkViewed
	s.handlers["incidents.acknowledge"] = s.incidentAcknowledge
	s.handlers["incidents.resolve"] = s.incidentResolve
	s.handlers["clips.list"] = s.clipsList
	s.handlers["clips.get"] = s.clipGet
	...
	s.handlers["residents.photos.delete"] = s.facePhotoDelete
	s.handlers["residents.photos.activate"] = s.facePhotoActivate
	s.handlers["residents.photos.remove_confirmed"] = s.facePhotoRemoveConfirmed
