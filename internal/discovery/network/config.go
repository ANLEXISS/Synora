...
func DefaultConfig() NetworkConfig {
	return NetworkConfig{SynoraNet: SynoraNetConfig{
		...
		Pairing:          PairingConfig{Enabled: true, WindowSeconds: 600, RequireAdminSession: true, RequireSetupToken: true, RequireDevicePublicKey: true, RequireObservedMACMatch: true, MaxPendingDevices: 5, ClaimEndpointEnabledOnlyDuringWindow: true},
