...
PROCEDURE = ROOT / "docs/v1/validation/M047_RKNN_ROCK5T_PROCEDURE.md"
...
class RknnQualificationProcedureTests(unittest.TestCase):
    def test_procedure_never_claims_fixture_success(self):
        ...
        self.assertIn("Radxa ROCK 5T", text)
    ...
    def test_required_measurements_are_explicit(self):
        text = PROCEDURE.read_text(encoding="utf-8")
        for marker in ("SCRFD", "ArcFace 512", "YOLOv8n", "p95", "NPU", "CPU", "température", "trois sources", "redémarrage"):
