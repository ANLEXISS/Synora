...
function buildConditionCatalog(): AutomationConditionDefinition[] {
  return [
    ...
    { kind: "security.mode", label: "Mode sécurité", description: "Mode durable du système.", operators: ["==", "!="], values: automationSecurityModeCatalog },
    { kind: "security.armed", label: "Sécurité armée", description: "État d’armement de la sécurité.", operators: ["==", "!="], values: automationSecurityArmedCatalog },
    { kind: "occupancy.expected", label: "Occupation attendue", description: "Présence attendue selon le mode.", operators: ["==", "!="], values: automationExpectedOccupancyCatalog },
    { kind: "manual_risk.active", label: "Risque manuel actif", description: "Risque temporaire injecté manuellement.", operators: ["==", "!="], values: automationManualRiskCatalog },
    {
      kind: "node.id",
      label: "Pièce",
